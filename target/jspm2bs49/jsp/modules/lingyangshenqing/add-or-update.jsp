		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑领养申请</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑领养申请</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">领养申请信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>性别</label>
										<input name="xingbie" id="xingbie" name="xingbie" class="form-control" placeholder="性别">
									</div>
									<div class="form-group col-md-6">
										<label>账号</label>
									...
									<div class="form-group col-md-6">
										<label>申请原因</label>
										<input name="shenqingyuanyin" id="shenqingyuanyin" name="shenqingyuanyin" class="form-control" placeholder="申请原因">
									</div>
									<div class="form-group col-md-6">
										<label>申请日期</label>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "lingyangshenqing/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("lingyangshenqing/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("lingyangshenqing/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.shenqingyuanyin != null && res.data.shenqingyuanyin != ''){
						...
						$("#shenqingyuanyin").attr('readonly','readonly');
					}
