					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑发布者</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">发布者信息</h3>
				...
				if(crossrefid && crossuserid) {
					...
					http("fabuzhe/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("fabuzhe/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
