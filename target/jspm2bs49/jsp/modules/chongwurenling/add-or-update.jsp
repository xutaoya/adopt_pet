		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑宠物认领</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑宠物认领</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">宠物认领信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>特征</label>
										<textarea  name="tezheng" class="form-control" id="tezheng" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>状态</label>
										<select id="zhuangtaiSelect" name="zhuangtai" class="form-control">
												<option value=""></option>
												<option class="zhuangtaiOption" value="已认领">
													已认领
												</option>
												<option class="zhuangtaiOption" value="未认领">
													未认领
												</option>
										</select>	
									</div>	
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "chongwurenling/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("chongwurenling/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("chongwurenling/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("chongwurenling/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
			...
			function fill(){
				...
				http(accountTableName+'/session','GET',{},(res)=>{
					if(res.code == 0){
						...
						if(res.data !=null && res.data.gerenzhanghao != null && res.data.gerenzhanghao != ''){
							$('#gerenzhanghao').val(res.data.gerenzhanghao)
							$("#gerenzhanghao").attr('readonly','readonly');
						}
						if(res.data !=null && res.data.gerenxingming != null && res.data.gerenxingming != ''){
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.tezheng != null && res.data.tezheng != ''){

						$("#tezheng").val(res.data.tezheng);
					}
