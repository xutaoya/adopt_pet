			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
		            ...
		            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.yishididian" type="text" :readonly="ro.yishididian" name="yishididian" id="yishididian" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
						<label class="layui-form-label">宠物特点：</label>
						<div class="layui-input-block">
							<input v-model="detail.chongwutedian" type="text" :readonly="ro.chongwutedian" name="chongwutedian" id="chongwutedian" autocomplete="off" class="layui-input">
						</div>
					</div>
		            <div class="layui-form-item" pane>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
                ...
                if(http.getParam('corss')){
					...
					for(var o in obj){
                                        ...
                                        if(o=='yishishijian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.yishishijian = true;
                                                jquery('#yishishijian').val(obj[o]);
                                                continue;
                                        }
                                        if(o=='yishididian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.yishididian = true;
                                                continue;
                                        }
                                        if(o=='chongwutedian'){
                                                vue.detail[o] = obj[o];
                                                vue.ro.chongwutedian = true;
                                                continue;
                                        }
                                        if(o=='zhanghao'){
                                                vue.detail[o] = obj[o];
				...
				if(!statusColumnName.startsWith("[")) {
					...
					http.requestJson(`${table}/update`,'post',obj,(res)=>{});
                        ...
                        if(crossrefid && crossuserid) {
                                ...
                                http.request('renlingxinxi/list', 'get', {
                                        page: 1,
                                        limit: 10,
                                        ...
                                        if(res.data.total>=crossoptnum) {
                                            ...
                                            // 提交数据
                                            http.requestJson('renlingxinxi' + '/add', 'post', data, function(res) {
                                                    layer.msg('提交成功', {
                                                            time: 2000,
                                                            icon: 6
                                                    }, function() {
