...
public class FabuzheController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		FabuzheEntity user = fabuzheService.selectOne(new EntityWrapper<FabuzheEntity>().eq("gerenzhanghao", username));
    ...
    public R register(@RequestBody FabuzheEntity fabuzhe){
    	...
    	FabuzheEntity user = fabuzheService.selectOne(new EntityWrapper<FabuzheEntity>().eq("gerenzhanghao", fabuzhe.getGerenzhanghao()));
		if(user!=null) {
