...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑认领信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑认领信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">认领信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>个人账号</label>
										<input name="gerenzhanghao" id="gerenzhanghao" name="gerenzhanghao" class="form-control" placeholder="个人账号">
									</div>
									<div class="form-group col-md-6">
										<label>个人姓名</label>
										<input name="gerenxingming" id="gerenxingming" name="gerenxingming" class="form-control" placeholder="个人姓名">
									</div>
									<div class="form-group col-md-6">
										<label>联系手机</label>
										<input name="lianxishouji" id="lianxishouji" name="lianxishouji" class="form-control" placeholder="联系手机">
									</div>
									<div class="form-group col-md-6">
										<label>遗失时间</label>
									...
									<div class="form-group col-md-6">
										<label>遗失地点</label>
										<input name="yishididian" id="yishididian" name="yishididian" class="form-control" placeholder="遗失地点">
									</div>
									<div class="form-group col-md-6">
										<label>宠物特点</label>
										<input name="chongwutedian" id="chongwutedian" name="chongwutedian" class="form-control" placeholder="宠物特点">
									</div>
									<div class="form-group col-md-6">
										<label>账号</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "renlingxinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("renlingxinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("renlingxinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function dataBind(){
			...
			$("#gerenzhanghao").val(ruleForm.gerenzhanghao);	
			$("#gerenxingming").val(ruleForm.gerenxingming);	
			$("#lianxishouji").val(ruleForm.lianxishouji);	
			$("#yishishijian-input").val(ruleForm.yishishijian);
			$("#yishididian").val(ruleForm.yishididian);	
			$("#chongwutedian").val(ruleForm.chongwutedian);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.gerenzhanghao != null && res.data.gerenzhanghao != ''){

						$("#gerenzhanghao").val(res.data.gerenzhanghao);
						$("#gerenzhanghao").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.gerenxingming != null && res.data.gerenxingming != ''){

						$("#gerenxingming").val(res.data.gerenxingming);
						$("#gerenxingming").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.lianxishouji != null && res.data.lianxishouji != ''){

						$("#lianxishouji").val(res.data.lianxishouji);
						$("#lianxishouji").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.yishididian != null && res.data.yishididian != ''){
						...
						$("#yishididian").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.chongwutedian != null && res.data.chongwutedian != ''){

						$("#chongwutedian").val(res.data.chongwutedian);
						$("#chongwutedian").attr('readonly','readonly');
					}
