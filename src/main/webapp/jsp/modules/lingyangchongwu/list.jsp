...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">领养宠物管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>领养宠物管理</span></li>
								<li class="breadcrumb-item active"><span>领养宠物列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">领养宠物列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										领养名称
									</label>
									<input type="text" id="lingyangmingchengSearch" class="form-control form-control-sm" placeholder="请输入领养名称" aria-controls="tableId">
									<label>
										类型
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('lingyangmingcheng')">领养名称<i id="lingyangmingchengIcon" class="fa fa-sort"></i></th>
											<th>宠物图片</th>
											...
											<th onclick="sort('lingyangxuzhi')">领养须知<i id="lingyangxuzhiIcon" class="fa fa-sort"></i></th>
											<th>宠物简介</th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#lingyangmingchengSearch').val() != null && $('#lingyangmingchengSearch').val() != ''){
				searchForm.lingyangmingcheng ="%" +  $('#lingyangmingchengSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("lingyangchongwu/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				lingyangmingcheng : searchForm.lingyangmingcheng,	
		...
		function setDataRow(item,number){
			...
			var lingyangmingchengCell  = document.createElement('td');

						 lingyangmingchengCell.innerHTML = item.lingyangmingcheng;

			row.appendChild(lingyangmingchengCell);
			var chongwutupianCell  = document.createElement('td');

				                var chongwutupianImg = document.createElement('img');
			chongwutupianImg.setAttribute('src',baseUrl+item.chongwutupian);
			chongwutupianImg.setAttribute('height',100);
			chongwutupianImg.setAttribute('width',100);
			chongwutupianCell.appendChild(chongwutupianImg);


			row.appendChild(chongwutupianCell);
			...
			var lingyangxuzhiCell  = document.createElement('td');

						 lingyangxuzhiCell.innerHTML = item.lingyangxuzhi;

			row.appendChild(lingyangxuzhiCell);
			var chongwujianjieCell  = document.createElement('td');

						  if(item.chongwujianjie != null && item.chongwujianjie != "" && item.chongwujianjie.length >= 11){
			  	chongwujianjieCell.innerHTML = item.chongwujianjie.substring(0, 10) + "..."; 
			  }else{
			  	chongwujianjieCell.innerHTML = item.chongwujianjie;
			  }


			row.appendChild(chongwujianjieCell);
			...
			var crossBtn0 = document.createElement('button');
            		crossBtn0.innerHTML = "领养"
			crossBtn0.setAttribute("type","button");
			crossBtn0.setAttribute("class","btn btn-primary btn-sm");
			crossBtn0.setAttribute("onclick","crossTable(" + JSON.stringify(item) + ",'lingyangshenqing','','zhuangtai','该宠物已被领养','已领养,未领养'.split(',')[0])");
			if(crossBtnControl('领养') == true){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("lingyangchongwu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function discussList(id) {
            ...
            window.location.href = "../discusslingyangchongwu/list.jsp"
        }
		//清除会重复渲染的节点
        function clear(){
	...
	function getSum(colName){
		http("lingyangchongwu"+colName,"GET",{
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"lingyangchongwu");
