		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑领养宠物</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑领养宠物</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">领养宠物信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									<input id="updateId" name="id" type="hidden">
									<div class="form-group col-md-6">
										<label>领养名称</label>
										<input name="lingyangmingcheng" id="lingyangmingcheng" name="lingyangmingcheng" class="form-control" placeholder="领养名称">
									</div>
									<div class="form-group col-md-6">
										<label>宠物图片</label>
										<div><img id="chongwutupianImg" src="" width="100" height="100">
										<div class="upload">选择文件<input name="file" type="file" id="chongwutupianupload" class="form-control-file"></div>
										<input name="chongwutupian" id="chongwutupian-input" type="hidden"></div>
									</div>
									<div class="form-group col-md-6">
										<label>类型</label>
									...
									<div class="form-group col-md-6">
										<label>性情</label>
										<input name="xingqing" id="xingqing" name="xingqing" class="form-control" placeholder="性情">
									</div>
									<div class="form-group col-md-6">
										<label>状态</label>
										<select id="zhuangtaiSelect" name="zhuangtai" class="form-control">
												...
												<option class="zhuangtaiOption" value="未领养">
													未领养
												</option>
										</select>	
									</div>	
									<div class="form-group col-md-6">
										<label>领养须知</label>
										<input name="lingyangxuzhi" id="lingyangxuzhi" name="lingyangxuzhi" class="form-control" placeholder="领养须知">
									</div>
									<div class="form-group col-md-6">
										<label>宠物简介</label>
										<textarea  name="chongwujianjie" class="form-control" id="chongwujianjie" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>发布日期</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "lingyangchongwu/info/" + id,
		...
		function upload(){
			$('#chongwutupianupload').fileupload({
				...
				dataType: 'json',
					...
					$("#chongwutupianImg").attr("src",baseUrl+"upload/"+data.result.file);								
				}
			});
				...
				if(crossrefid && crossuserid) {
					...
					http("lingyangchongwu/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("lingyangchongwu/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("lingyangchongwu/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dataBind(){
			...
			$("#lingyangmingcheng").val(ruleForm.lingyangmingcheng);	
			...
			$("#lingyangxuzhi").val(ruleForm.lingyangxuzhi);	
			$("#chongwujianjie").val(ruleForm.chongwujianjie);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.lingyangmingcheng != null && res.data.lingyangmingcheng != ''){

						$("#lingyangmingcheng").val(res.data.lingyangmingcheng);
						$("#lingyangmingcheng").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.chongwutupian != null && res.data.chongwutupian != ''){

						$("#chongwutupianImg").attr("src",baseUrl+res.data.chongwutupian);
						$("#chongwutupian-input").val(res.data.chongwutupian);
					}
					...
					if(res.data != null && res.data != '' && res.data.xingqing != null && res.data.xingqing != ''){
						...
						$("#xingqing").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.lingyangxuzhi != null && res.data.lingyangxuzhi != ''){

						$("#lingyangxuzhi").val(res.data.lingyangxuzhi);
						$("#lingyangxuzhi").attr('readonly','readonly');
					}
					if(res.data != null && res.data != '' && res.data.chongwujianjie != null && res.data.chongwujianjie != ''){

						$("#chongwujianjie").val(res.data.chongwujianjie);
					}
