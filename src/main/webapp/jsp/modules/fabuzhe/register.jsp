...
<style>
	...
	body {
		...
		width: 100%;
		height: 100%;
						background-image: url(http://codegen.caihongy.cn/20220124/3c320321abda4b019db01ef9c0cf7e8d.png) !important;
					}
	.container {
		padding: 0;
		margin: 0;
	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input  name="gerenzhanghao" placeholder="个人账号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">个人姓名</label> 
							<input  name="gerenxingming" placeholder="个人姓名" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<input  name="lianxishouji" placeholder="联系手机" class="form-control-i">
							</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "fabuzhe/register";
				$.ajax({ 
					type: "POST",
					url: url,
